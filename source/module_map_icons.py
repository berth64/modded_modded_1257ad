...
map_icons = [
	("player", 0, "player", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0.0),

	("player_horseman", 0, "player_horseman", avatar_scale, snd_gallop, 0.15, 0.173, 0.0),

	("gray_knight", 0, "knight_a", avatar_scale, snd_gallop, 0.15, 0.173, 0.0),

	("vaegir_knight", 0, "knight_b", avatar_scale, snd_gallop, 0.15, 0.173, 0.0),

	("flagbearer_a", 0, "flagbearer_a", avatar_scale, snd_gallop, 0.15, 0.173, 0.0),

	("flagbearer_b", 0, "flagbearer_b", avatar_scale, snd_gallop, 0.15, 0.173, 0.0),

	("peasant", 0, "peasant_a", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0.0),

	("khergit", 0, "khergit_horseman", avatar_scale, snd_gallop, 0.15, 0.173, 0.0),

	("khergit_horseman_b", 0, "khergit_horseman_b", avatar_scale, snd_gallop, 0.15, 0.173, 0.0),

	("axeman", 0, "bandit_a", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0.0),

	("woman", 0, "woman_a", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0.0),

	("woman_b", 0, "woman_b", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0.0),

	("town", mcn_no_shadow, "Gulltown", 0.5, snd_click, 0.0, 0.0, 0.0),

	("town_steppe", mcn_no_shadow, "map_town_steppe_a", 0.5, snd_click, 0.0, 0.0, 0.0),

	("town_desert", mcn_no_shadow, "map_town_desert_a", 0.5, snd_click, 0.0, 0.0, 0.0),

	("village_a", mcn_no_shadow, "Stoney_Sept", banner_scale, snd_click, 0.0, 0.0, 0.0),

	("village_b", mcn_no_shadow, "Saltpans", banner_scale, snd_click, 0.0, 0.0, 0.0),

	("village_c", mcn_no_shadow, "map_village_c", banner_scale, snd_click, 0.0, 0.0, 0.0),

	("village_burnt_a", mcn_no_shadow, "map_village_burnt_a", banner_scale, snd_click, 0.0, 0.0, 0.0),

	("village_deserted_a", mcn_no_shadow, "map_village_deserted_a", banner_scale, snd_click, 0.0, 0.0, 0.0),

	("village_burnt_b", mcn_no_shadow, "map_village_burnt_b", banner_scale, snd_click, 0.0, 0.0, 0.0),

	("village_deserted_b", mcn_no_shadow, "map_village_deserted_b", banner_scale, snd_click, 0.0, 0.0, 0.0),

	("village_burnt_c", mcn_no_shadow, "map_village_burnt_c", banner_scale, snd_click, 0.0, 0.0, 0.0),

	("village_deserted_c", mcn_no_shadow, "map_village_deserted_c", banner_scale, snd_click, 0.0, 0.0, 0.0),

	("village_snow_a", mcn_no_shadow, "eastern_village", banner_scale, snd_click, 0.0, 0.0, 0.0),

	("village_snow_burnt_a", mcn_no_shadow, "map_village_snow_burnt_a", banner_scale, snd_click, 0.0, 0.0, 0.0),

	("village_snow_deserted_a", mcn_no_shadow, "map_village_snow_deserted_a", banner_scale, snd_click, 0.0, 0.0, 0.0),

	("camp", mcn_no_shadow, "camp_tent", 0.2, snd_click, 0.0, 0.0, 0.0),

	("ship", mcn_no_shadow, "boat_sail_on", 0.25, snd_footstep_grass, 0.0, 0.05, 0.0),

	("ship_on_land", mcn_no_shadow, "boat_sail_off", 0.2, snd_click, 0.0, 0.0, 0.0),

	("castle_a", mcn_no_shadow, "european_castle", 0.45, snd_click, 0.0, 0.0, 0.0),

	("castle_b", mcn_no_shadow, "map_castle_b", 0.45, snd_click, 0.0, 0.0, 0.0),

	("castle_c", mcn_no_shadow, "map_castle_c", 0.45, snd_click, 0.0, 0.0, 0.0),

	("castle_d", mcn_no_shadow, "map_castle_d", 0.45, snd_click, 0.0, 0.0, 0.0),

	("town_snow", mcn_no_shadow, "map_town_snow_a", 0.5, snd_click, 0.0, 0.0, 0.0),

	("castle_snow_a", mcn_no_shadow, "map_castle_snow_a", 0.45, snd_click, 0.0, 0.0, 0.0),

	("castle_snow_b", mcn_no_shadow, "map_castle_snow_b", 0.45, snd_click, 0.0, 0.0, 0.0),

	("mule", 0, "icon_mule", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0.0),

	("cattle", 0, "icon_cow", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0.0),

	("training_ground", mcn_no_shadow, "training", banner_scale, snd_click, 0.0, 0.0, 0.0),
	...
	("longship", 0, "map_longship", 0.2, snd_sea_travel, 0.0, 0.05, 0.0),

	("longship_poland", 0, "map_longship_poland", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_denmark", 0, "map_longship_denmark", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_teu", 0, "map_longship_teu", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_lithuania", 0, "map_longship_lithuania", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_hre", 0, "map_longship_hre", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_hungary", 0, "map_longship_hungary", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_novgorod", 0, "map_longship_novgorod", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_england", 0, "map_longship_england", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_france", 0, "map_longship_france", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_norway", 0, "map_longship_norway", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_scotland", 0, "map_longship_scotland", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_ireland", 0, "map_longship_ireland", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_sweden", 0, "map_longship_sweden", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_mongol", 0, "map_longship_mongol", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_galicia", 0, "map_longship_galicia", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_portugal", 0, "map_longship_portugal", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_aragon", 0, "map_longship_aragon", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_castile", 0, "map_longship_castile", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_navarra", 0, "map_longship_navarra", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_granada", 0, "map_longship_granada", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_papal", 0, "map_longship_papal", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_byzantine", 0, "map_longship_byzantine", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_jerusalem", 0, "map_longship_jerusalem", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_sicily", 0, "map_longship_sicily", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_mamluke", 0, "map_longship_mamluke", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_latin", 0, "map_longship_latin", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_ilkhanate", 0, "map_longship_ilkhanate", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_hafsid", 0, "map_longship_hafsid", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_serbia", 0, "map_longship_serbia", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_bulgaria", 0, "map_longship_bulgaria", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_marinid", 0, "map_longship_marinid", 0.25, snd_click, 0.0, 0.0, 0.0),

	("longship_pirate", 0, "map_longship_pirate", 0.25, snd_click, 0.0, 0.0, 0.0),

	("constantinople", mcn_no_shadow, "map_constantinople", 0.6, snd_click, 0.0, 0.0, 0.0),

	("prague", mcn_no_shadow, "map_prague", 0.4, snd_click, 0.0, 0.0, 0.0),

	("andalusian", mcn_no_shadow, "map_icon_andalusian", 0.5, snd_click, 0.0, 0.0, 0.0),

	("italy", mcn_no_shadow, "map_icon_italy", 0.5, snd_click, 0.0, 0.0, 0.0),

	("russian", mcn_no_shadow, "map_icon_russian", 0.5, snd_click, 0.0, 0.0, 0.0),

	("eastern", mcn_no_shadow, "map_icon_eastern", 0.5, snd_click, 0.0, 0.0, 0.0),

	("eastern2", mcn_no_shadow, "map_icon_eastern2", 0.5, snd_click, 0.0, 0.0, 0.0),

	("wooden", mcn_no_shadow, "map_icon_wood", 0.5, snd_click, 0.0, 0.0, 0.0),

	("acre", mcn_no_shadow, "map_icon_acre", 0.5, snd_click, 0.0, 0.0, 0.0),

	("french_town", mcn_no_shadow, "french_town", 0.55, snd_click, 0.0, 0.0, 0.0),

	("dutch_town", mcn_no_shadow, "dutch_town", 0.5, snd_click, 0.0, 0.0, 0.0),

	("dutch_castle", mcn_no_shadow, "dutch_castle", 0.45, snd_click, 0.0, 0.0, 0.0),

	("european_castle", mcn_no_shadow, "european_castle", 0.45, snd_click, 0.0, 0.0, 0.0),

	("french_castle", mcn_no_shadow, "french_castle", 0.45, snd_click, 0.0, 0.0, 0.0),

	("norman_castle", mcn_no_shadow, "norman_castle", 0.45, snd_click, 0.0, 0.0, 0.0),

	("medi_castle", mcn_no_shadow, "medi_castle", 0.45, snd_click, 0.0, 0.0, 0.0),

	("castle_icon_a", mcn_no_shadow, "castle_icon_a", 0.45, snd_click, 0.0, 0.0, 0.0),

	("rus", mcn_no_shadow, "rus_town_icon", 0.55, snd_click, 0.0, 0.0, 0.0),

	("manor_icon", mcn_no_shadow, "map_village_a", banner_scale, snd_click, 0.0, 0.0, 0.0),

	("merc_icon", mcn_no_shadow, "camp_tent", 0.25, snd_click, 0.0, 0.0, 0.0),

	("crusaders", 0, "crusaders", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0.0),

	("italy_new_a", mcn_no_shadow, "Norvos", 0.4, snd_click, 0.0, 0.0, 0.0),

	("italy_new_b", mcn_no_shadow, "Lorath", 0.4, snd_click, 0.0, 0.0, 0.0),

	("teutonic_town", mcn_no_shadow, "teutonic_town", 0.4, snd_click, 0.0, 0.0, 0.0),

	("italy_castle", mcn_no_shadow, "Dorne_Town", 0.45, snd_click, 0.0, 0.0, 0.0),

	("village_eastern", mcn_no_shadow, "eastern_village", banner_scale, snd_click, 0.0, 0.0, 0.0),

	("village_italy", mcn_no_shadow, "village_italy", banner_scale, snd_click, 0.0, 0.0, 0.0),

	("village_middle_europe", mcn_no_shadow, "village_middle_europe", banner_scale, snd_click, 0.0, 0.0, 0.0),

	("village_byzantium", mcn_no_shadow, "village_byzantium", banner_scale, snd_click, 0.0, 0.0, 0.0),

	("castle_byzantium", mcn_no_shadow, "castle_byzantium", 0.45, snd_click, 0.0, 0.0, 0.0),

	("bandit_marker", mcn_no_shadow, "map_bandit_marker", 0.2, snd_click, 0.0, 0.0, 0.0),

	("bandit_lair", mcn_no_shadow, "map_bandit_lair", 0.2, snd_click, 0.0, 0.0, 0.0),
