...
skills = [
	...
	("persuasion", "Persuasion", sf_base_att_cha, 10, "This_skill_helps_you_make_other_people_accept_your_point_of_view._It_also_lowers_the_minimum_level_of_relationship_needed_to_get_NPCs_to_do_what_you_want._(Personal_skill)"),
	...
	("looting", "Looting", sf_base_att_int|sf_effects_party, 10, "This_skill_increases_the_amount_of_loot_obtained_by_10%%_per_skill_level._(Party_skill)"),
