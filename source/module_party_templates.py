...
party_templates = [
	...
	("looters", "Looters", icon_axeman|carries_goods(8)|pf_label_small, 0, fac_outlaws, bandit_personality, [(trp_looter, 15, 100)]),

	("manhunters", "Manhunters", icon_gray_knight|pf_label_small, 0, fac_manhunters, soldier_personality, [(trp_manhunter, 9, 40)]),

	("curonians", "Kursi", icon_axeman|carries_goods(2)|pf_label_small, 0, fac_kingdom_35, soldier_personality, [(trp_balt_skirmisher, 7, 10), (trp_balt_footman, 7, 10), (trp_balt_jav, 7, 10), (trp_balt_veteran_jav, 1, 4), (trp_balt_billman, 7, 10), (trp_balt_spearman, 7, 10)]),

	("prussians", "Pruteni", icon_axeman|carries_goods(2)|pf_label_small, 0, fac_kingdom_34, soldier_personality, [(trp_balt_skirmisher, 7, 10), (trp_balt_footman, 7, 10), (trp_balt_jav, 7, 10), (trp_balt_veteran_jav, 1, 4), (trp_balt_billman, 7, 10), (trp_balt_spearman, 7, 10)]),

	("samogitians", "Zemaiciai", icon_axeman|carries_goods(2)|pf_label_small, 0, fac_kingdom_36, soldier_personality, [(trp_balt_skirmisher, 7, 10), (trp_balt_footman, 7, 10), (trp_balt_jav, 7, 10), (trp_balt_veteran_jav, 1, 4), (trp_balt_billman, 7, 10), (trp_balt_spearman, 7, 10)]),

	("yotvingians", "Jotvingiai", icon_axeman|carries_goods(2)|pf_label_small, 0, fac_kingdom_33, soldier_personality, [(trp_balt_skirmisher, 7, 10), (trp_balt_footman, 7, 10), (trp_balt_jav, 7, 10), (trp_balt_veteran_jav, 1, 4), (trp_balt_billman, 7, 10), (trp_balt_spearman, 7, 10)]),

	("welsh", "Cymry", icon_axeman|carries_goods(2)|pf_label_small, 0, fac_kingdom_37, soldier_personality, [(trp_merc_welsh_bowman_commander, 2, 12), (trp_merc_welsh_bowman, 12, 24), (trp_merc_kern_infantry, 24, 36)]),
	...
	("merc_party", "Manor Army", icon_gray_knight|pf_show_faction, 0, fac_commoners, soldier_personality, []),
	...
	("steppe_bandits", "Raiders", icon_khergit|carries_goods(2)|pf_label_small, 0, fac_outlaws, bandit_personality, [(trp_steppe_bandit, 3, 20), (trp_peasant_rebel, 3, 20), (trp_bandit, 3, 20), (trp_peasant_woman, 0, 5, pmf_is_prisoner), (trp_farmer, 0, 5, pmf_is_prisoner)]),

	("taiga_bandits", "Renegades", icon_axeman|carries_goods(2)|pf_label_small, 0, fac_outlaws, bandit_personality, [(trp_mountain_bandit, 5, 45), (trp_forest_bandit, 5, 45), (trp_taiga_bandit, 5, 45), (trp_peasant_woman, 0, 5, pmf_is_prisoner), (trp_farmer, 0, 5, pmf_is_prisoner)]),

	("desert_bandits", "Desert Raiders", icon_vaegir_knight|carries_goods(2)|pf_label_small, 0, fac_outlaws, bandit_personality, [(trp_desert_bandit, 10, 100)]),

	("forest_bandits", "Hardened Bandits", icon_axeman|carries_goods(2)|pf_label_small, 0, fac_outlaws, bandit_personality, [(trp_peasant_rebel, 3, 100), (trp_bandit, 3, 100), (trp_brigand, 3, 100), (trp_raider, 0, 2), (trp_rebel_leader, 0, 2), (trp_peasant_woman, 0, 10, pmf_is_prisoner)]),

	("mountain_bandits", "Bandits", icon_axeman|carries_goods(2)|pf_label_small, 0, fac_outlaws, bandit_personality, [(trp_peasant_rebel, 4, 20), (trp_bandit, 4, 20), (trp_brigand, 4, 20), (trp_farmer, 0, 5, pmf_is_prisoner), (trp_peasant_woman, 0, 5, pmf_is_prisoner)]),
	...
	("troublesome_bandits", "Troublesome Bandits", icon_axeman|carries_goods(9)|pf_always_visible|pf_quest_party, 0, fac_outlaws, bandit_personality, [(trp_bandit, 14, 55)]),

	("bandits_awaiting_ransom", "Bandits Awaiting Ransom", icon_axeman|carries_goods(9)|pf_always_visible|pf_auto_remove_in_town|pf_quest_party, 0, fac_neutral, bandit_personality, [(trp_bandit, 24, 58), (trp_kidnapped_girl, 1, 1, pmf_is_prisoner)]),
