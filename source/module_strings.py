...
strings = [
	...
	("town_alt_prosperity_40", "You hear the occasional grumble in the marketplace about the price of everyday items, but there appears to be a reasonable amount of goods for sale. You see the occasional abandoned building, shop, or cart, but nothing more than the ordinary."),
	...
	("secret_sign_2", "I am selling these fine Turkic tapestries. Would you like to buy some?"),
	...
	("retirement_text_2", "Only too late do you realise that your money won't last. It doesn't take you long to fritter away what little you bothered to save. Once every florin has evaporated in your hands you are forced to start a life of crime in the backstreets of {s9}, using your skills to eke out a living robbing coppers from women and poor townsmen."),
	...
	("npc6_intro_response_2", "Sorry I cant afford to spare any florins."),
	...
	("npc2_backstory_b", "As I am sure you know the pope recently called a crusade against our baltic state, and in order to help our people my town decided to send a unit to join the army the King had assembled, I was marching along as happy as lark when the captain calls me out of formation and tells me to go and find some supplies.  So off I go looking for a bite to eat for me and my chums."),
	...
	("npc27_backstory_c", "So I then found work as an mercenary earning a few florins here and their, recently I was with a small band of friends, but we were ambushed by some local rebels who wanted our gear i managed to escape thanks to my clever steppe Horse."),
	...
	("npc1_backstory_later", "My purse which was once overflowing with florins is now boarding on empty. The order was all I had, all I had ever wanted...."),
	...
	("npc16_backstory_later", "I have been here and about, tending to the sick and taking what reward I can.  The few florins I make are barely enough for me to replenish my jug of wine. I should be grateful for the chance to find other work."),
	...
	("npc1_payment", "Before we depart, I would ask that you pay me {reg3} florins to ensure me that you are no trickster abusing a man down on his luck."),

	("npc2_payment", "{!}."),

	("npc3_payment", "Thank you. Now, to seal off our agreement, I ask for {reg3} florins from you. It's a piece advice my father gave me. He told me 'Batsaikhan, never fight for a barbarian before {he/she} pays you your worth of gold first'."),

	("npc4_payment", "Well Jarl, in the country arm rings are given for service but I see you have none so i'll settle for a small sum instead. {reg3} florins will about do it."),

	("npc5_payment", "Excellent. Before we depart, I insist that you pay me {reg3} to show that you will honor our agreement."),

	("npc6_payment", "{Sir/My lady} I need {reg3} florins to pay for my mothers funeral as I could not leave her unburried."),
	...
	("npc25_payment", "Before I sign up, there is the small matter of some expenses I have incurred while staying here -- {reg3} florins. Do you think that you could cover those for me, as a gesture of friendship?"),

	("npc26_payment", "If you could clear my bill with the house I would be most greatful its only {reg3} florins."),

	("npc27_payment", "Well been a mercenary I clearly need a sign you can provide me with regular income {reg3} florins ought to be enough."),
	...
	("npc1_payment_response", "Okay,here is {reg3} florins consider it a favour from one soldier to another."),

	("npc2_payment_response", "{!}."),

	("npc3_payment_response", "Well... here's {reg3} florins, then. Your first payment."),

	("npc4_payment_response", "{reg3} florins are a small price for my own beserker."),

	("npc5_payment_response", "Certainly. Here's {reg3} florins."),

	("npc6_payment_response", "Consider it an advance on your regular pay.... here are {reg3} florins.  May she rest in piece."),
	...
	("npc25_payment_response", "Of course, here's {reg3} florins. Make ready to leave soon."),

	("npc26_payment_response", "Consider it done here is {reg3} florins."),

	("npc27_payment_response", "A Il-khanate mercenary for only  {reg3} florins cheap at twice the price."),
	...
	("comment_you_captured_a_lord_allied_friendly_spiteful", "I heard that you captured {s54}. I hope that you squeezed him for every florin."),
	...
	("swadian_rebellion_pretender_intro", "CLAIMANT 1 INTRO"),

	("vaegir_rebellion_pretender_intro", "CLAIMANT 2 INTRO"),

	("khergit_rebellion_pretender_intro", "CLAIMANT 3 INTRO"),

	("nord_rebellion_pretender_intro", "My name is Erik Abelson. I was the duke of Schleswig, but by all rights I should be the king of Denmark."),

	("rhodok_rebellion_pretender_intro", "CLAIMANT 5 INTRO"),

	("sarranid_rebellion_pretender_intro", "CLAIMANT 6 INTRO"),

	("swadian_rebellion_pretender_story_1", "CLAIMANT 1 STORY 1"),

	("vaegir_rebellion_pretender_story_1", "CLAIMANT 2 STORY 1"),

	("khergit_rebellion_pretender_story_1", "I am Simon de Montfort, the sixth Earl of Leicester, who should be the king of England."),

	("nord_rebellion_pretender_story_1", "Christopher used trickery to nullify my rightful claim to the throne."),

	("rhodok_rebellion_pretender_story_1", "CLAIMANT 5 STORY 1"),

	("sarranid_rebellion_pretender_story_1", "I am Knut Haakonsson, son of Haakon the Crazy, and soon the conquerer of Scotland."),

	("swadian_rebellion_pretender_story_2", "I am Sir James de Audley, Justiciar of Ireland. I need to take back Ireland for England."),

	("vaegir_rebellion_pretender_story_2", "CLAIMANT 2 STORY 2"),

	("khergit_rebellion_pretender_story_2", "Henry III needs to be replaced. We need a new form of government that does not give the king absolute power."),

	("nord_rebellion_pretender_story_2", "Seven years ago, his brother went south to Rendsbug in order to quell local unrest. My father invited him to his home in Schleswig in hospitality. He was then kidnapped and executed by whom I do not know."),

	("rhodok_rebellion_pretender_story_2", "CLAIMANT 5 STORY 2"),

	("sarranid_rebellion_pretender_story_2", "This 'Scotland' is rightful Norwegian land, not the barbian horde it belongs to."),

	("swadian_rebellion_pretender_story_3", "Ireland is a land of constant unrest and barbaric tribes. It needs taming."),

	("vaegir_rebellion_pretender_story_3", "CLAIMANT 2 STORY 3"),

	("khergit_rebellion_pretender_story_3", "In 1215, over 40 years ago, we had the Baron's War which established the Magna Carta. But Henry III does not care for this invaluable document."),

	("nord_rebellion_pretender_story_3", "But what I do know is that my father had nothing to do with it. Christopher, the snake, convinced the church to canonize his brother. My father was murdered and my claim was no longer valid."),

	("rhodok_rebellion_pretender_story_3", "CLAIMANT 5 STORY 3"),

	("sarranid_rebellion_pretender_story_3", "Norway has become dull. I wish to go back to our roots and invade England again, make them fear us once more."),

	("swadian_rebellion_monarch_response_1", "The Irish rebels manage to own much of the territory. If we wish to become a power to be feared we need to destroy the Irish once and for all."),

	("vaegir_rebellion_monarch_response_1", "CLAIMANT 2 KING RESPONSE 1"),

	("khergit_rebellion_monarch_response_1", "I aim to set in motion a second Baron's War, to remind Henry why we made this document. This time, however, the penalty shall be severe."),

	("nord_rebellion_monarch_response_1", "That little shite Erik thinks the throne belongs to him!"),

	("rhodok_rebellion_monarch_response_1", "CLAIMANT 5 KING RESPONSE 1"),

	("sarranid_rebellion_monarch_response_1", "We were vikings! We drove fear into the hearts of those cowardly islanders. We need to bring those days back by gaining a foothold."),

	("swadian_rebellion_monarch_response_2", "Under my rule, Ireland shall become a principality of England, with order and law."),

	("vaegir_rebellion_monarch_response_2", "CLAIMANT 2 KING RESPONSE 2"),

	("khergit_rebellion_monarch_response_2", "We aren't frogs, the French have their own little kingdom. If you see him again tell him to stay where he is."),

	("nord_rebellion_monarch_response_2", "His father, the scum, murdered my brother over a dispute. The only good that could come of this is Erik's death."),

	("rhodok_rebellion_monarch_response_2", "CLAIMANT 5 KING RESPONSE 2"),

	("sarranid_rebellion_monarch_response_2", "Knut is nostalgic for times he hasn't lived and never will. The days of vikings are long dead, we have our own problems to worry about rather than a group of miserable wet islands."),
	...
	("kingdom_16_adjective", "Portuguese"),

	("kingdom_17_adjective", "Aragonese"),

	("kingdom_18_adjective", "Castillian"),

	("kingdom_19_adjective", "Navarrian"),

	("kingdom_20_adjective", "Andalusian"),
	...
	("raise_ladder", "Destructible Target"),
	...
	("em_with_regard_to_her_ladyship_we_were_looking_specifically_for_a_groom_of_some_distinction_fight_hard_count_your_florins_and_perhaps_some_day_in_the_future_we_may_speak_of_such_things_my_good_man", "Em... With regard to her ladyship, we were looking specifically for a groom of some distinction. Fight hard, count your florins, and perhaps some day in the future we may speak of such things, my good man!"),
	...
	("strange_that_one_didnt_seem_like_your_orfloriny_troublemaker_he_didnt_drink_all_that_much__he_just_stood_there_quietly_and_watched_the_door_you_may_wish_to_consider_whether_you_have_any_enemies_who_know_you_are_in_town_a_pity_that_blood_had_to_be_spilled_in_my_establishment", "Strange. That one didn't seem like your ordinary troublemaker. He didn't drink all that much -- he just stood there, quietly, and watched the door. You may wish to consider whether you have any enemies who know you are in town... A pity that blood had to be spilled in my establishment..."),
	...
	("quick_battle_scene_1", "Frozen Lake"),

	("quick_battle_scene_2", "Oasis"),

	("quick_battle_scene_3", "Castle Skirmish"),

	("quick_battle_scene_4", "Desert Castle"),

	("quick_battle_scene_5", "Steppe Castle"),

	("quick_battle_troop_1", "The stereotypical 13th century western European knight. Clad in mail with a helmet, kite shield, lance, sword, and mace."),

	("quick_battle_troop_2", "Renowned archers hailing from Wales, the Welsh longbowmen are excellent against the enemy from afar and are capable of defending themselves with sword and buckler."),

	("quick_battle_troop_3", "Heavy infantry from Denmark, the obudshaer is equipped with some of the heaviest armor available and a close range infantry polearm. Excellent against other infantry or some cavalry."),

	("quick_battle_troop_4", "Almogavars are light infantry hailing from Iberia trained in the use of javelins and slings, almost antiquated weapons by this period. Good for getting javelins in before the enemy infantry formation closes in."),

	("quick_battle_troop_5", "Ritterbruders represent the pinnacle of knights during this period, bedecked in a coat of plates and a great helm, these knights are the best available."),

	("quick_battle_troop_6", "Geonese arbalesters utilize the extremely powerful arbalest; the strongest crossbow available in the 13th century. Selling their service as mercenaries, these crossbowmen are more than capable in melee as they wear a hauberk, kite shield, and sword."),

	("quick_battle_troop_7", "Adopting the cavalry archer tactics of the Mongols, these mamluks are the cream of the crop of Muslim troops. Armed with bow, shield, and scimitar."),

	("quick_battle_troop_8", "A relic of a bygone age, the cataphract favors extreme heavy armor to mobility. Using a mace to counter other heavily armored opponents and javelins to attack anything he can't reach, the cataphract is a fearsome opponent."),

	("quick_battle_troop_9", "Originally mercenaries from Scandinavia, these men also hail from Germany, Russia, and England. Personal bodyguard to the Byzantine emperor, these men are well armed, armored, and very tough."),

	("quick_battle_troop_10", "Mixing javelins with heavy armor, these pagans are some of the toughest opposition against the ongoing Baltic crusades."),

	("quick_battle_troop_11", "A relatively uncommon weapon for the time, the pike saw very effective use later on during the 14th and 15th centuries. Excellent against enemy cavalry."),
	...
	("describe_secondary_input", " In addition, you will also need to purchase {s11} worth {reg10} florins."),
	...
	("item_pool_abandon", "Let your men collect all the items left and continue."),
	...
	("hero_wpn_slot_pistol", "Sling "),

	("hero_wpn_slot_musket", "Staff sling "),

	("hero_wpn_slot_bullets", "Sling shot "),
	...
	("type_musket", "Staff sling "),

	("type_bullets", "Sling shot "),
	...
	("manor_grainfarm_description", "Produces grain, can pay taxes in goods or in florins."),

	("manor_livestock_description", "Produces meet, can pay taxes in goods or in florins."),

	("manor_fruitfarm_description", "Produces fruit, can pay taxes in goods or in florins."),

	("manor_fisher_description", "Produces smoked fish, can pay taxes in goods or in florins."),

	("manor_bakery_description", "Produce Bread, can pay taxes in goods or in florins."),

	("manor_winery_description", "Produce Wine, can pay taxes in goods or in florins."),

	("manor_brewery_description", "Produces ALE!, can pay taxes in goods or in florins."),

	("manor_potter_description", "Produces pottery, can pay taxes in goods or in florins."),

	("manor_blacksmith_description", "Produces tools, allows tier 4 production buildings, can pay taxes in goods or in florins."),

	("manor_butcher_description", "Produces meat products, can pay taxes in goods or in florins."),

	("manor_oilmaker_description", "Produces oil, can pay taxes in goods or in florins."),

	("manor_linenworkshop_description", "Produces linen cloth, can pay taxes in goods or in florins."),

	("manor_woolworkshop_description", "Produces wool cloth, can pay taxes in goods or in florins."),

	("manor_tannery_description", "Produces leatherwork, can pay taxes in goods or in florins."),

	("manor_prison_description", "Grants ransom broker. Does not provide tax."),

	("manor_armorsmith_description", "Produces armor."),

	("manor_weaponsmith_description", "Produces melee weapons."),

	("manor_fletcher_description", "Produces ranged weapons."),

	("manor_breeder_description", "Produces horses."),

	("manor_walls_description", "The manor no longer will be infested by bandits, (has no effect if the bound village is looted) - costs 500 florins to maintain."),

	("manor_gathering_army_explained", "Alright sir, however summoning men to arms will not only decrease the population that pay taxes, but will also decrease the settlement prosperity as there won't be enough hands working in the field or in the shops. You will also have to pay for their upkeep. That being said, what size of a force do you wish to gather?"),
	...
	("npc_payment", "Excellent. I require {reg3} florins as a compensation for my family while I am away."),

	("npc_payment_recruit", "Of course, I'll get my steward to provide the florins to you right away."),
	...
	("doghotel_config_shortcut_key", "Shortcut key: F11"),

	("doghotel_anti_autoblock", "Anti-autoblock"),

	("doghotel_escape_menu_line_1", "Brainy Bots"),

	("doghotel_escape_menu_line_2", "In-game hotkey: F11"),
	...
	("doghotel_module_merger_packages_v2", "1257AD modded{version=}{!}Brainy Bots{version=3}"),

	("doghotel_module_merger_packages_v1", "1257AD modded{!}Brainy Bots"),
